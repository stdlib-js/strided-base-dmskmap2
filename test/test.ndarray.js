...
tape( 'the function has an arity of 14', function test( t ) {
	t.strictEqual( dmskmap2.length, 14, 'arity of 14' );
	t.end();
});
...
tape( 'the function supports an `x` stride', function test( t ) {
	...
	dmskmap2( N, x, 2, 0, y, 1, 0, m, 1, 0, z, 1, 0, add );
...
tape( 'the function supports an `x` offset', function test( t ) {
	...
	dmskmap2( N, x, 1, 2, y, 1, 0, m, 1, 0, z, 1, 0, add );
...
tape( 'the function supports a `y` stride', function test( t ) {
	...
	dmskmap2( N, x, 1, 0, y, 2, 0, m, 1, 0, z, 1, 0, add );
...
tape( 'the function supports a `y` offset', function test( t ) {
	...
	dmskmap2( N, x, 1, 0, y, 1, 1, m, 1, 0, z, 1, 0, add );
...
tape( 'the function supports a `mask` stride', function test( t ) {
	...
	dmskmap2( N, x, 1, 0, y, 1, 0, m, 2, 0, z, 1, 0, add );
...
tape( 'the function supports a `mask` offset', function test( t ) {
	...
	dmskmap2( N, x, 1, 0, y, 1, 0, m, 1, 1, z, 1, 0, add );
...
tape( 'the function supports a `z` stride', function test( t ) {
	...
	dmskmap2( N, x, 1, 0, y, 1, 0, m, 1, 0, z, 2, 0, add );
...
tape( 'the function supports a `z` offset', function test( t ) {
	...
	dmskmap2( N, x, 1, 0, y, 1, 0, m, 1, 0, z, 1, 2, add );
...
tape( 'the function returns a reference to the destination array', function test( t ) {
	...
	out = dmskmap2( x.length, x, 1, 0, y, 1, 0, m, 1, 0, z, 1, 0, add );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns the destination array', function test( t ) {
	...
	dmskmap2( -1, x, 1, 0, y, 1, 0, m, 1, 0, z, 1, 0, add );
	t.deepEqual( z, expected, 'returns expected value' );

	dmskmap2( 0, x, 1, 0, y, 1, 0, m, 1, 0, z, 1, 0, add );
	t.deepEqual( z, expected, 'returns expected value' );
...
tape( 'the function supports negative strides', function test( t ) {
	...
	dmskmap2( N, x, -2, x.length-1, y, -1, y.length-2, m, -1, m.length-3, z, -1, z.length-1, add ); // eslint-disable-line max-len
...
tape( 'the function supports complex access patterns', function test( t ) {
	...
	dmskmap2( N, x, 2, 1, y, -1, y.length-1, m, -2, m.length-2, z, -2, z.length-1, add ); // eslint-disable-line max-len
